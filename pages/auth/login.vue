  ...
  <div>
    <!-- <div class="login_card">
      <div class="login_inner_card">
        <img src="assets/images/logo/logo_login.png" alt="Logo">
      </div>
    </div>   -->
        ...
        <div class="login_inner_card">
          ...
          <div class="relative">
            ...
            <button @click="showPassword = !showPassword" type="button">
              ...
              <svg v-else xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="text-[#FFFFFF66] size-6 absolute right-3 top-2">
